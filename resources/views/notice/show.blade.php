...
.title-wrapper {
    ...
    width: 100%; /* Set a width as per your layout */
}

.animate-title {
    display: inline-block; /* Allows for smooth transitions */
    animation: typing 4s steps(30, end) infinite alternate; /* Adjust duration and steps */
    font-variant: all-small-caps; /* Ensures text appears in uppercase */
}
